        ...
        <div className="flex flex-col h-full pt-16 sm:pt-20 px-4 sm:px-6 pb-8 sm:pb-12 overflow-y-auto">
          ...
          <div className="mb-6 sm:mb-8 border-b border-white/10 pb-3 sm:pb-4">
            ...
            <img
              ...
              className="w-8 h-8 sm:w-10 sm:h-10 object-contain"
              />
                <span className="text-base sm:text-lg font-black tracking-tighter text-white">Movies4U™ </span>
             </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 text-center">
             <div className="h-px bg-white/5 w-1/2 mx-auto mb-3 sm:mb-4"></div>
             <p className="text-[9px] sm:text-[10px] font-black text-gray-600 uppercase tracking-[0.5em] sm:tracking-[0.6em]">Movies4U™ Official</p>
          </div>
        </div>
      </aside>
    </>
