...
const Home: React.FC<HomePageProps> = ({ trending, popularMovies, topRatedTV, heroItems }) => {
  ...
  const schema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://movies4u-official.vercel.app/search?q={search_term_string}",
  ...
  return (
    <div className="min-h-screen bg-miraj-black pb-20">
      <SEO 
        title="Movies4U™ Official" 
        description="Movies4U™ Official - Official Site for free Movie and Tv Shows in HD quality. No registration required."
        schema={schema}
      />
