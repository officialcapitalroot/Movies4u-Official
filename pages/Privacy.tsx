...
const Privacy: React.FC = () => {
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO title="Privacy Policy - Movies4U™ Official" description="Privacy Policy for Movies4U™ Official." />
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
            <section>
                ...
                <p>
                    Welcome to Movies4U™ Official. We respect your privacy and are committed to protecting your personal data. 
